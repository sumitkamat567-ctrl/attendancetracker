...
class _SubjectHistoryPageState extends State<SubjectHistoryPage> {
        ...
        children: [
          ...
          GridView.builder(
            ...
            gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
              ...
              mainAxisSpacing: 8,
              crossAxisSpacing: 8,
              // ✅ FIXED: Increased aspect ratio to prevent vertical overflow
            ...
            itemBuilder: (context, index) {
              ...
              final dayActions =
              actions.where((a) => _sameDay(a.date, date)).toList();
  ...
  Widget _dayCell(int day, List<AttendanceAction> actions) {
    ...
    return Column(
      mainAxisSize: MainAxisSize.min, // Added to keep column compact
      ...
      children: [
        ...
        // Simplified the status indicator to save space
        if (hasRecord)
          Text(
            isPresent ? "P" : "A",
            style: TextStyle(
      ...
      builder: (_) {
        return Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                "Mark attendance for ${date.day}/${date.month}/${date.year}",
                style: const TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.bold,
                ),
